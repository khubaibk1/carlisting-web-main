    ...
    const Dropdown = ({ options, initialValue, scroll, toggle }) => {
        ...
        return (
            <div>
                <div ref={dropdownRef} className="relative">
                    <div
                        className={`rounded-md flex items-center gap-[2px] h-[50px] cursor-pointer py-[10px] px-[16px] `}
                    ...
                    {isOpen && (
                        <div className='z-[999]'>
                            <div className='absolute mt-2 z-50 shadow-xl w-[300px] h-[320px] bg-[#f3f4f4] transform translate-x-[-10px] ' style={{ boxShadow: "0 0  5px rgba(0, 0, 0, 0.5)" }}>
                                ...
                                <div className={`w-[300px] h-[300px] absolute ${scroll ? 'overflow-y-scroll' : ''} bg-white z-50`}>
                                    {options.map((option) => (
                                        <div
                                            key={option}
