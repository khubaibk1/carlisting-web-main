...
const NewUsed = () => {
  ...
  const handleOptionSelect = (person) => {
    setSelected(person);
              ...
              {() => (
                <>
                  <div className="relative ">
                    <Listbox.Button
                      className="border w-[412px] h-[60px]"
                    ...
                    >
                      <Listbox.Options className="absolute pb-7 pt-2 px-2 z-10 mt-1 w-[412px] bg-white border text-base shadow-lg focus:outline-none sm:text-sm">
                                ...
                                <div className="flex items-center ml-5 cursor-pointer w-full">
                                  <div>
                                    <input
                                      ...
                                      checked={selected}
                                      onChange={() => handleOptionSelect(person)}
                                    />
                                  </div>
                                  <span
                        ...
                        <button
                          className="text-[#09A122] border-2 font-[500] border-[#09A122] rounded-md w-[87px] py-[8px]"
                          onClick={toggleDropdown}
                        >
                          Done
                        </button>
