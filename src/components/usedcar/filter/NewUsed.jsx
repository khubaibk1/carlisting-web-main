                                    ...
                                    <div className="relative ">
                                        <Listbox.Button className="border w-[412px] h-[60px] ">
                                            ...
                                            <span className="pointer-events-none absolute inset-y-0 right-4 flex items-center ">
                                                <svg onClick={rotateSVG} className={`transform rotate-${rotation} cursor-pointer transition-transform duration-500 ease-in-out`} xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 29 29" fill="none">
