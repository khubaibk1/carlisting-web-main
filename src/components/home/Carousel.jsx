...
function SamplePrevArrow(props) {
  ...
  return (
    <div
      className={`cursor-pointer bg-[#D0BCDF] hover:bg-[#672797]  transition-all ease-in duration-300  z-50 absolute top-[50%] left-1  p-1 rounded-full `}
      onClick={onClick}
    >
...
const Carousel = () => {
  ...
  return (
    <div className="relative mt-[28rem]">
      <Wrapper>
        <div className="flex flex-col justify-start items-start">
          <h1 className="text-[36px] font-[500] pl-5">
          ...
          <Slider {...settings} className="w-[100%]">
            {data.map((item, index) => (
              ...
              >
                <div className="bg-white flex flex-col   w-[380px] shadow-lg">
                  <Image
                    src={item.img}
                    alt=""
                    width={800}
