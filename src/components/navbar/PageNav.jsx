            ...
            <Wrapper>
                <div className="flex justify-between gap-20 items-center text-black py-5 ">
                    ...
                    <div className="flex items-center gap-10">
                        {/* sign in */}
                        <div className="flex  items-center space-x-2 pl-2  rounded-md pr-[30px] md:pr-[0px]">
                            <button
                            ...
                            >
                                ...
                                <span className="block lg:hidden md:hidden sm:block text-[#672797]">Home</span>
                            </button>
                        </div>

                        {/* start a project  */}
                        <button
                                className="hidden lg:block md:block sm:hidden xl:block "
                        >
